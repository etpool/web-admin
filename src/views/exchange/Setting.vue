      ...
      <Modal
          ...
          <ul>
            ...
            <li><span><i>*</i> 是否推荐：</span>
              <p>
                <RadioGroup v-model="fixFlag">
                  <Radio :label="1"><em>推荐</em></Radio>
                  <Radio :label="0"><em>不推荐</em></Radio>
                </RadioGroup>
              </p>
            </li>
            <li><span><i>*</i> 假数据状态：</span>
              <p>
                <RadioGroup v-model="fixFakeDataStatus">
                  <Radio :label="0"><em>关闭</em></Radio>
                  <Radio :label="1"><em>开启</em></Radio>
                </RadioGroup>
              </p>
            </li>
            <li><span><i>*</i> 排序：</span>
            ...
            <Col span="12">
              ...
              <Row :gutter="30">
                ...
                <ul>
                  ...
                  <li><span><i>*</i> 假数据状态：</span>
                    <p>
                      <RadioGroup v-model="fakeDataStatus">
                        <Radio :label="0"><em>关闭</em></Radio>
                        <Radio :label="1"><em>开启</em></Radio>
                      </RadioGroup>
                    </p>
                ...
                "Button",
                {
                  ...
                  on: {
                    click: () => {
                      ...
                      this.fixFlag = obj.row.flag;
                      this.fixFakeDataStatus = obj.row.fakeDataStatus;
                    }
                  }
                },
                "设置"
    ...
    confirmExchangeEngineMoel(){
      ...
      if(this.operation == 1){
          ...
          let obj ={
            ...
            flag: this.fixFlag,
            fakeDataStatus: this.fixFakeDataStatus,
            sort: this.fixSort,
