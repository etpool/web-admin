...
import { queryEntrustList, queryEntrustListOut, cancelEntrustOrder, queryContractCoinList } from '@/service/getData'
...
export default {
  ...
  methods: {
    exportExcel() {
      ...
      queryEntrustListOut(this.searchForm)
          .then(res => {
            // 文件下载
            console.log(res)
