        ...
        <Col span="24">
          <div class="searchWrapper" style="float:left;">
              ...
              <div class="btns">
                  ...
                  <Button type="default" size="small" @click="clearSearch">清空</Button>
              </div>
          </div>
        </Col>
      </Row>
...
import { queryPositionList, queryPositionListOut, cancelEntrustOrder, queryContractCoinList } from '@/service/getData'
...
export default {
  ...
  methods: {
    exportExcel() {
      this.searchForm.isOut = 1
      queryPositionListOut(this.searchForm)
          .then(res => {
            // 文件下载
            console.log(res)
