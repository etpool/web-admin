...
let findSlideArr = [
    ...
    { id: 256, path: 'coinprotocol', icon: 'document', component: resolve => { require(['@/views/system/coinprotocol.vue'], resolve) } },
    { id: 258, path: 'coinext', icon: 'document', component: resolve => { require(['@/views/system/coinext.vue'], resolve) } },
    { id: 264, path: 'automainconfig', icon: 'document', component: resolve => { require(['@/views/system/automainconfig.vue'], resolve) } },
    // { id: 94, path: 'userwithdrawals', icon: 'document', component: resolve => { require(['@/views/finance/WithdrawalsExamine.vue'], resolve) } },
    { id: 269, path: 'withdraw', icon: 'document', component: resolve => { require(['@/views/finance/withdraw.vue'], resolve) } },
    ...
    { id: 266, path: 'recharge', icon: 'document', component: resolve => { require(['@/views/finance/recharge.vue'], resolve) } },
