				...
				<div class="businessCheckMask" v-show="businessCheckMask">
					<div class="wrapper">
						...
						<Row class="businessInfo">
							<Col span="8">手机号：+{{ businessCheckInfo.areaCode  }} {{ businessCheckInfo.telno  }}</Col>
							<Col span="8">whatsApp：{{ businessCheckInfo.wechat }}</Col>
							<Col span="8">微信：{{ businessCheckInfo.qq }}</Col>
