...
export const sysAppRevisionSave = data => {
    return data.id && data.id > 0 ? put('admin/system/app-revision/' + data.id, data) : post('admin/system/app-revision', data)
}
...
export const queryEntrustListOut = data => postOut('admin/swap/order/page-query', data);
...
export const queryPositionListOut = data => postOut('admin/swap/position/page-query', data);
